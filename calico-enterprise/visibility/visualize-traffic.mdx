...
<ImageCaption>
  The image shows service graph in namespace view containing a node "*", which is not representing a namespace but aggregation of service groups from different namespaces.
</ImageCaption>
