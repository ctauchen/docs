...
| Install and upgrade            | - Non-cluster hosts<br />- Typha component for scaling (Linux-based feature)                                                                                                                                                     |
...
| Visibility and troubleshooting | - Packet capture<br />- DNS logs<br />- iptables logs<br />- L7 logs                                                                                                                                                                                      |
| Threat defense                 | - Honeypods<br />- DPI<br />- Performance hotspots<br />- WAF                                                                                                                                                                                                       |
...
Because of the way the Windows data planehandles rules, the following limitations are required to avoid performance issues:
