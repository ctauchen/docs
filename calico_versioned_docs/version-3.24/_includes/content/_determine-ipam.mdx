...
If it is present, you are using the {variables.prodname} IPAM. If the IPAM is not {variables.prodname}, or the 10-calico.conflist file does not exist, you cannot use these features in your cluster.
