...
relevant {variables.prodname} components with an etcd user name and password. You
can create a single etcd user for {variables.prodname} that has permission to read
...
This table sets out where to configure each component of {variables.prodname} for
