...
>
  <div className='col-md-6'>
    ...
    <p>
      {{ prodname }} gives you a choice of data planes, including a pure Linux eBPF data plane, a standard Linux
      networking data plane, and a Windows HNS data plane . Whether you prefer cutting edge features of eBPF, or the
  ...
  <div className='col-md-6'>
    <img
      className='img-responsive center-block'
      src='/img/calico/intro/multiple-dataplanes.png'
    />
  </div>
</div>
...
>
  <div className='col-md-6'>
    <img
      className='img-responsive center-block'
      src='/img/calico/intro/best-practices.png'
    />
  </div>
  <div className='col-md-6'>
    <h3
...
>
  ...
  <div className='col-md-6'>
    <img
      className='img-responsive center-block'
      src='/img/calico/intro/performance.png'
    />
  </div>
</div>
...
>
  <div className='col-md-6'>
    <img
      className='img-responsive center-block'
      src='/img/calico/intro/scale.png'
    />
  </div>
  <div className='col-md-6'>
    <h3
...
>
  ...
  <div className='col-md-6'>
    <img
      className='img-responsive center-block'
      src='/img/calico/intro/interoperability.png'
    />
  </div>
</div>
...
>
  <div className='col-md-6'>
    <img
      className='img-responsive center-block'
      src='/img/calico/intro/deployed.png'
    />
  </div>
  <div className='col-md-6'>
    <h3
...
>
  ...
  <div className='col-md-6'>
    <img
      className='img-responsive center-block'
      src='/img/calico/intro/policy.png'
    />
  </div>
</div>
...
>
  <div className='col-md-6'>
    <img
      className='img-responsive center-block'
      src='/img/calico/intro/community.png'
    />
  </div>
  <div className='col-md-6'>
    <h3
...
>
  ...
  <div className='col-md-6'>
    <img
      className='img-responsive center-block'
      src='/img/calico/calico-cloud-small.png'
    />
    <div
