...
### Verify {variables.prodname} installation

You can verify {variables.prodname} installation in your cluster by issuing the following command.
...
Congratulations you now have a Kind cluster equipped with {variables.prodname}
