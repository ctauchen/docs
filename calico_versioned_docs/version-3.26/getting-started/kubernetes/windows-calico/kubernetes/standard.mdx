...
Install {variables.prodnameWindows} on Kubernetes clusters. The standard installation for {variables.prodnameWindows} requires more time and expertise to configure. If you need to get started quickly, we recommend the [Quickstart](../quickstart.mdx).
