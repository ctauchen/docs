...
Install {variables.prodnameWindows} manually on your Kubernetes cluster in approximately 5 minutes.
...
Review the [Linux requirements](../../requirements.mdx) and the [{variables.prodnameWindows} requirements](../requirements.mdx).
...
1. Ensure that BGP is disabled since you're using VXLAN.
   If you installed {variables.prodname} using operator, you can do this by:
