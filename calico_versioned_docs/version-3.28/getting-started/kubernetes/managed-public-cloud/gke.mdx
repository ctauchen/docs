...
Enable {variables.prodname} in GKE managed Kubernetes service.

## Value

GKE has built-in support for {variables.prodname}, providing a robust implementation of the full Kubernetes Network Policy API. GKE users wanting to go beyond Kubernetes network policy capabilities can make full use of the {variables.prodname} Network Policy API.

## How to

To enable {variables.prodname} network policy enforcement, follow these step-by-step instructions:
