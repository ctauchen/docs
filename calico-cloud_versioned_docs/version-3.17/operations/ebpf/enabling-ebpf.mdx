---
description: Steps to enable the eBPF data planeon an existing cluster.
---

# Enable eBPF on an existing cluster

import EbpfValue from '@site/calico-cloud_versioned_docs/version-3.17/_includes/content/_ebpf-value.mdx';
