...
- [Configuring namespaces and pods to use egress gateways](#configuring-namespaces-and-pods-to-use-egress-gateways)
...
### Configuring namespaces and pods to use egress gateways
