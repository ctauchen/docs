...
{{prodname}}'s eBPF data planenative service handling (rather than kube-proxy) which preserves source IP address.
...
data plane supports native service handling. This preserves source IP to
