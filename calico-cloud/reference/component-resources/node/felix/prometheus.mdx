...
| `felix_int_dataplane_apply_time_seconds`                   | Time in seconds that it took to apply a data planeupdate.                                                                                                 |
| `felix_int_dataplane_failures`                             | Number of times data planeupdates failed and will be retried.                                                                                             |
...
| `felix_int_dataplane_messages`                             | Number data planemessages by type.                                                                                                                        |
...
If you have more than a handful of active selctors and `felix_label_index_selector_evals{result="false"}` is many
