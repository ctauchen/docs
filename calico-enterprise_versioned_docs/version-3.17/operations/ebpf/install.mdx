...
import EbpfValue from '@site/calico-enterprise_versioned_docs/version-3.17/_includes/content/_ebpf-value.mdx';
...
Install the eBPF data planeduring the initial installation of {{prodname}}.
...
# For more information, see: https://docs.tigera.io/calico-enterprise/latest/reference/installation/api/#operator.tigera.io/v1
