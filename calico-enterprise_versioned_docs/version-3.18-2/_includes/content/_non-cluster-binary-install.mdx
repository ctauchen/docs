...
import NonClusterReadOnlyStep from '@site/calico-enterprise_versioned_docs/version-3.18-2/_includes/content/_non-cluster-read-only-step.mdx';
import EnvironmentFile from '@site/calico-enterprise_versioned_docs/version-3.18-2/_includes/components/EnvironmentFile';
