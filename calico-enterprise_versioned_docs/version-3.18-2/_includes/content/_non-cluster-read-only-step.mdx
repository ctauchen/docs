...
import CreateKubeconfig from '@site/calico-enterprise_versioned_docs/version-3.18-2/_includes/content/_create-kubeconfig.mdx';
...
```bash
kubectl apply -f {variables.filesUrl}/manifests/non-cluster-host-clusterrole.yaml
