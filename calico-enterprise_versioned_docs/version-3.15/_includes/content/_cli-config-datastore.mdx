...
giving only trusted administrators the permission to modify {variables.prodname}
...
Now you are ready to read and configure most aspects of {variables.prodname}. You can
