...
- Fixed bug where EGW pods were in a crashloop.
...
- Upgrading {variables.prodname} v3.15.2 on Rancher/RKE from {variables.prodname} v3.13.0 currently requires manually terminating the calico-node container for upgrade to proceed.
