...
1. Use the following command to download the `calicoq` binary.
   ...
   <CodeBlock language='bash'>
    curl -o calicoq -O -L {variables.downloadsurl}/ee/binaries/{variables.releaseTitle}/calicoq
   </CodeBlock>
...
1. Confirm that the image has loaded by typing `docker images`.
   ...
   {variables.releases[0].components.calicoq.image}    {variables.releases[0].components.calicoq.version}            e07d59b0eb8a   2 minutes ago   42MB
   ```
