...
[DNAT](about-networking#nat) is used to map the destination IP address from the Cluster IP to the
...
As part of this process [NAT](about-networking#nat) is used to map the destination IP address and
