...
{variables.prodname} [system requirements](../requirements.mdx). If you don't,
...
## Installing {variables.prodname} for policy and flannel (aka Canal) for networking
...
1. Issue the following command to install {variables.prodname}.
...
1. Download the {variables.prodname} networking manifest.
