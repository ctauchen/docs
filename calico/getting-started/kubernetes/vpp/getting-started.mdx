...
The VPP data planehas some minor behavioural differences wrt the other {{prodname}} data planes and some of the features are not supported. For details please refer to [Known issues & unsupported features](./specifics.mdx).
...
Start by getting the appropriate yaml manifest file for the VPP data planeresources:
